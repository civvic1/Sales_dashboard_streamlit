...
def preprocesamiento():
  ...
  df_itens_pedidos = df_itens_pedidos.dropna(subset=['id_recibo', 'producto_id','pedido_id'])
  df_pedidos = df_pedidos.dropna(subset=['pedido_id', 'producto_id','vendedor_id'])
  ...
  # Merge 3: Combinar merged2 con df_location usando 'ciudad'
  merged3 = pd.merge(merged2, df_location[['municipio', 'longitude', 'latitude']], on='state_name')
